...
rm -rf $FULL_CLIENT_CERTIFICATE_NAME.ovpn
aws ec2 export-client-vpn-client-configuration --region $AWS_REGION --client-vpn-endpoint-id $CLIENT_VPN_ID --output text > $FULL_CLIENT_CERTIFICATE_NAME.ovpn
